...
class OrderAdmin(admin.ModelAdmin):
    ...
    list_filter = ('product', 'ordered_date', 'status')
    ...
    def product_info(self, obj):
        product = obj.product.category.slug if obj.product.category.slug != 'cloth' else obj.product.category.slug + 'es'
        link = reverse(
            f'admin:products_{product}_change', args=(obj.product.id,))
